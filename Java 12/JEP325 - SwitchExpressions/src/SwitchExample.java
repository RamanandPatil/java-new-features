...
public class SwitchExample {
    ...
    public static void main(String[] args) {
        catchExceptions(
                ...
                SwitchExample::switchExpression,
                SwitchExample::block,
                SwitchExample::multipleCaseLabels,
                SwitchExample::exhaustiveness,
                SwitchExample::noFallThrough,
                SwitchExample::voidExpression,
                SwitchExample::polyExpression,
                SwitchExample::moreTypes,
                SwitchExample::switchExpressionWithColon,
                SwitchExample::returnFromWithin
        );
    }
...
//		}
    ...
    private static void catchExceptions(Runnable... blocks) {
        Arrays.stream(blocks).forEach(SwitchExample::catchException);
    }
